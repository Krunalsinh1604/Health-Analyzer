                ...
                <div className="results-summary">
                  <div className="summary-grid">
                    <div>
                      ...
                      <strong className={result.diabetes_prediction === 'Positive' ? 'text-alert' : 'text-success'}>
                        {result.diabetes_prediction}
                      </strong>
                    </div>
                    <div>
                      <span>Confidence</span>
                      <strong>{result.ml_model_insights ? `${result.ml_model_insights.probability}%` : "High"}</strong>
                    </div>
                  </div>
                  ...
                  <div style={{ marginTop: '20px', marginBottom: '10px' }}>
                    ...
                    <div className="pill" style={{ display: 'inline-flex', marginBottom: '10px' }}>
                      <span>Algorithm</span>
                      <strong>{result.ml_model_insights?.algorithm || "Machine Learning Model"}</strong>
                    </div>
                    <p style={{ color: 'var(--muted)', fontSize: '0.9rem', lineHeight: '1.5' }}>
                      Prediction generated by trained {result.ml_model_insights?.algorithm || "machine learning model"}.
                    </p>
                  </div>
